...
function findLongestWord(words) {
  ...
  words.forEach((word) => {
    ...
    console.log("longestWord:", longestWord, "current word:", word);
  ...
  /*
  1. visit every word (maybe forloop/foreach) Psycho
  2. check its length 6
  3. store longest word so far longestWord = Jaws 
  4. (maybe an if condidtion) if the current word is longer than my longest word, than update the longest word longestWord = Inception 
  9 vs 9 5 vs 4 
  5. Once the loop is over then return the longest word
  */
}
